...
export class AwsIamRoleController {
    ...
    @ApiOperation({
        ...
        description:
            ...
            'Por padrão (roleScope=user) exibe apenas roles com path "/" operacoes criadas explicitamente por usuários via console, CLI ou IaC. ' +
    ...
    // IAM Roles - Sincronização com AWS

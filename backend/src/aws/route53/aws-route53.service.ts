...
import { ListHostedZonesCommand, GetHostedZoneCommand, ListTagsForResourceCommand, type HostedZone } from '@aws-sdk/client-route-53';
...
function mapDbHostedZone(zone: AwsRoute53HostedZone) {
    return {
        ...
        vpc: zone.vpc ? { id: zone.vpc.id, awsVpcId: zone.vpc.awsVpcId, cidrBlock: zone.vpc.cidrBlock, state: zone.vpc.state } : null,
    };
}

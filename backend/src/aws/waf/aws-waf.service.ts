...
import { ListWebACLsCommand, GetWebACLCommand, ListTagsForResourceCommand, type WebACLSummary } from '@aws-sdk/client-wafv2';
        ...
        for (const scope of WAF_SCOPES) {
            ...
            for (const summary of webAcls) {
                ...
                try {
                    ...
                    tags =
                        TagInfoForResource?.TagList?.reduce<Record<string, string>>((acc, t) => {

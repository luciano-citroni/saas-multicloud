...
@Entity('web_apps', { schema: 'azure' })
@Unique('UQ_azure_web_apps_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzureWebApp {
    ...
    @Column({ type: 'varchar', length: 20, name: 'state', nullable: true })
    state!: string | null;

...
@Entity('app_service_plans', { schema: 'azure' })
@Unique('UQ_azure_app_service_plans_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzureAppServicePlan {
    ...
    @Column({ type: 'varchar', length: 50, name: 'kind', nullable: true })
    kind!: string | null;

...
@Entity('key_vaults', { schema: 'azure' })
@Unique('UQ_azure_key_vaults_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzureKeyVault {
    ...
    @Column({ type: 'varchar', length: 255, name: 'vault_uri', nullable: true })

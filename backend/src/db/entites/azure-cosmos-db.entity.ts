...
@Entity('cosmos_db_accounts', { schema: 'azure' })
@Unique('UQ_azure_cosmos_db_accounts_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzureCosmosDb {
    ...
    @Column({ type: 'varchar', length: 50, name: 'database_account_offer_type', nullable: true })
    databaseAccountOfferType!: string | null;

    @Column({ type: 'varchar', length: 255, name: 'document_endpoint', nullable: true })

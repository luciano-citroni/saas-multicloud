...
@Entity('application_gateways', { schema: 'azure' })
@Unique('UQ_azure_application_gateways_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzureApplicationGateway {

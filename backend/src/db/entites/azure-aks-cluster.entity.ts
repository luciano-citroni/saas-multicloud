...
@Entity('aks_clusters', { schema: 'azure' })
@Unique('UQ_azure_aks_clusters_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzureAksCluster {
    ...
    @Column({ type: 'varchar', length: 30, name: 'kubernetes_version', nullable: true })

...
@Entity('vmss', { schema: 'azure' })
@Unique('UQ_azure_vmss_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzureVmss {
    ...
    @Column({ type: 'varchar', length: 100, name: 'sku', nullable: true })
    sku!: string | null;

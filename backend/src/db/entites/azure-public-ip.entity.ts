...
@Entity('public_ips', { schema: 'azure' })
@Unique('UQ_azure_public_ips_account_azure_id', ['cloudAccountId', 'azureId'])
export class AzurePublicIp {
    ...
    @Column({ type: 'varchar', length: 20, name: 'allocation_method', nullable: true })
